  ...
  return (
    <div className="space-y-6">
      ...
      <div className="print-only-header">
        <div className="flex justify-between items-end">
          ...
          <div className="text-right">
            ...
            <p className="text-xs font-medium">Period: <span className="font-bold">{toUI(dateRange.from)} to {toUI(dateRange.to)}</span></p>
          </div>
        </div>
      </div>
        ...
        <Card className="md:col-span-1 shadow-sm border-primary/10 h-fit print-hidden">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <Label className="text-xs font-black uppercase text-primary tracking-widest">Date Range (DD/MM/YYYY)</Label>
      ...
      <div className="print-footer">
        Generated by Citydrive Management Portal on {format(new Date(), 'dd/MM/yyyy HH:mm')}
      </div>
    </div>
  );
}
