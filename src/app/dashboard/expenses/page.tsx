  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="grid gap-1"><h2 className="text-2xl font-bold tracking-tight">Business Expenses</h2><p className="text-muted-foreground text-sm">{isAdmin ? 'School-wide costs.' : `Expenses for ${formatBranchName(profile?.branch || 'your branch')}.`}</p></div>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2"><Label className="font-bold flex items-center gap-2">Branch {!isAdmin && <Lock className="h-3 w-3 text-muted-foreground" />}</Label>{isAdmin ? (
              ...
              <div className="h-11 flex items-center px-3 rounded-md border-2 border-primary/10 bg-muted/30 font-black text-primary uppercase tracking-tight">
                ...
                {formatBranchName(formData.branch || profileBranch || 'Kainatty')}
              </div>
            )}</div>
